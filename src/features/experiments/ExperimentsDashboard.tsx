            ...
            {[
               ...
               <div key={i} className="bg-white rounded-[3rem] border border-navy-100 p-8 shadow-sm flex flex-col group hover:shadow-xl transition-all relative overflow-hidden">
                  ...
                  <div className="flex items-baseline gap-3 mb-2">
                     ...
                     <span className={`text-[10px] font-black px-2 py-0.5 rounded-full border ${stat.sub.startsWith('+') ? 'bg-emerald-50 text-emerald-700 border-emerald-100' : 'bg-navy-50 text-navy-400 border-navy-100'
                        }`}>
                        {stat.sub}
                     </span>
                  </div>
               ...
               <table className="w-full text-left">
                  <thead>
                     <tr className="bg-navy-50/50 text-[9px] font-black text-navy-300 uppercase tracking-[0.25em] border-b border-navy-50">
                        ...
                        <th className="px-12 py-6">Unique Visitors</th>
                        ...
                        <tr key={i} className="group hover:bg-navy-50/50 transition-all cursor-pointer">
                           ...
                           <td className="px-12 py-8">
                              <div className="flex items-center gap-3">
                                 ...
                                 {exp.uplift !== '-' && (
                                    <span className={`px-2 py-0.5 rounded-lg text-[9px] font-black uppercase tracking-widest border ${exp.uplift.startsWith('+') ? 'bg-emerald-50 text-emerald-700 border-emerald-100' : 'bg-navy-50 text-navy-400 border-navy-100'
                                       }`}>{exp.uplift}</span>
                                 )}
                              </div>
                           </td>
                           <td className="px-12 py-8">
                              <span className={`inline-flex items-center gap-2 px-4 py-1.5 rounded-full text-[9px] font-black uppercase tracking-widest border shadow-sm ${exp.status === 'Running' ? 'bg-emerald-50 text-emerald-700 border-emerald-100' : 'bg-navy-50 text-navy-400 border-navy-100'
                                 }`}>

...
const Login: React.FC = () => {
  ...
  // Where to redirect after login — resolved dynamically based on role
      ...
      <div className="w-full lg:w-1/2 flex flex-col relative bg-white overflow-y-auto">
        ...
        <div className="flex justify-end p-8 shrink-0">
          <div className="flex items-center gap-6">
            ...
            <p className="text-[10px] font-black uppercase tracking-widest text-navy-400">
              {step === 'CREDENTIALS' ? "New Member?" : "Wrong Account?"}
              <Link
                to={step === 'CREDENTIALS' ? ROUTES.REGISTER : ROUTES.LOGIN}
                onClick={step === 'MFA' ? () => setStep('CREDENTIALS') : undefined}
                className="text-primary hover:underline ml-2"
              >
                {step === 'CREDENTIALS' ? "Join Us" : "Switch Account"}
              </Link>
            </p>
          </div>
        </div>
            ...
            {step === 'CREDENTIALS' ? (
              <div className="space-y-12 animate-in fade-in slide-in-from-right duration-700">
                ...
                >
                  ...
                  <span className="text-[10px] font-black uppercase tracking-widest text-navy-700 group-hover:text-navy-950">Sign in with Google</span>
                </button>
                ...
                <form className="space-y-8" onSubmit={handleLogin}>
                  <div className="space-y-3">
                    <label className="text-[10px] font-black text-navy-400 uppercase tracking-widest block px-1">Email Address</label>
              ...
              <div className="space-y-12 animate-in fade-in zoom-in duration-500">
                ...
                <div className="bg-white p-10 rounded-[3.5rem] border-2 border-primary shadow-2xl space-y-10 relative overflow-hidden">
                  ...
                  <form className="space-y-8" onSubmit={(e) => { e.preventDefault(); navigate(intendedPath || ROUTES.MY_DASHBOARD, { replace: true }); }}>
                    <div className="space-y-4">
        ...
        <div className="p-10 text-center xl:px-44 pb-12 opacity-40">
          <p className="text-[9px] font-black text-navy-300 uppercase tracking-widest leading-loose">
            ...
            <a className="hover:text-primary hover:underline mx-4 transition-colors" href="#">Flight Status</a>

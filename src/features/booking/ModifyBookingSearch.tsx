...
const ModifyBookingSearch: React.FC = () => {
      ...
      <div className="p-8 max-w-6xl mx-auto space-y-10 animate-in slide-in-from-left duration-500 font-display pb-32">
         ...
         <div className="space-y-6">
            <nav className="flex items-center gap-2 text-[10px] font-black uppercase tracking-[0.3em] text-navy-300">
               <button onClick={() => navigate(ROUTES.MANAGE_BOOKING)} className="hover:text-primary transition-all">Booking Summary</button>
               <span className="material-symbols-outlined text-xs">chevron_right</span>
               <span className="text-primary">Change Flight</span>
            </nav>
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 border-b border-navy-100 pb-8">
               <div className="space-y-1">
                  ...
                  <p className="text-navy-500 font-medium italic mt-2 text-lg">Changing flight for booking: XYZ123</p>
               </div>
               <div className="bg-primary/5 px-6 py-3 rounded-[1.5rem] border border-primary/20 shadow-inner flex items-center gap-4">
                  <span className="text-[10px] font-black text-primary uppercase tracking-[0.2em]">Travel Credit</span>
               ...
               <div className="p-10 flex flex-col md:flex-row gap-10">
                  <div className="flex-1 space-y-8">
                     <div className="flex items-center gap-4">
                        <span className="px-4 py-1.5 rounded-xl bg-navy-50 text-navy-400 text-[10px] font-black uppercase tracking-widest border border-navy-100 shadow-inner">Your Current Flight</span>
                     ...
                     <div className="flex items-center gap-10">
                        ...
                        <div className="flex-1 flex flex-col items-center px-4 relative">
                           ...
                           <span className="text-[8px] font-black text-navy-200 uppercase tracking-[0.3em] mt-3">Non-stop</span>
                        </div>
         ...
         <section className="bg-white rounded-[3.5rem] border border-navy-100 p-10 shadow-2xl space-y-10 relative overflow-hidden">
            ...
            <div className="flex items-center justify-between px-2 relative z-10">
               <h3 className="text-xl font-black text-navy-950 uppercase tracking-tight">Search Available Flights</h3>
               <button className="text-[10px] font-black text-primary uppercase underline tracking-widest decoration-2 underline-offset-4" onClick={() => {}} title="Coming soon">Advanced Filters</button>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 relative z-10">
               <div className="space-y-3">
                  <label className="text-[10px] font-black text-navy-300 uppercase tracking-widest block px-1">Origin Airport</label>
               ...
               <div className="space-y-3">
                  <label className="text-[10px] font-black text-navy-300 uppercase tracking-widest block px-1">Destination</label>
                  <div className="relative group">
               ...
               <div className="space-y-3">
                  <label className="text-[10px] font-black text-navy-300 uppercase tracking-widest block px-1">New Travel Date</label>
                  <div className="relative group">
            ...
            <div className="flex justify-end relative z-10 pt-4">
               <button onClick={() => { /* search triggered */ }} className="px-12 py-5 bg-primary text-white font-black uppercase text-xs tracking-[0.3em] rounded-3xl shadow-2xl shadow-primary/30 hover:scale-105 active:scale-95 transition-all flex items-center gap-4">
                  <span className="material-symbols-outlined text-xl">refresh</span> Search Flights
               </button>
            </div>
         </section>
         ...
         <section className="space-y-8">
            <div className="flex items-center justify-between px-6">
               <div className="flex items-center gap-4">
                  <h3 className="text-xl font-black text-navy-950 uppercase tracking-tight">3 Alternative Flights Found</h3>
                  <span className="px-3 py-1 rounded-full bg-navy-50 text-navy-400 text-[9px] font-black uppercase tracking-widest border border-navy-100 shadow-inner">Results Ready</span>
               </div>
               <span className="text-[10px] font-bold text-navy-400 uppercase tracking-widest italic opacity-60">Price difference from your original booking</span>
            </div>
            ...
            <div className="space-y-6">
               {[
                  ...
                  <div key={i} className="bg-white rounded-[3rem] border border-navy-100 shadow-sm hover:shadow-xl hover:border-primary/40 transition-all p-10 group relative overflow-hidden">
                     {opt.fastest && <div className="absolute top-0 right-0 bg-primary text-white text-[8px] font-black px-6 py-2 rounded-bl-2xl tracking-[0.3em] uppercase shadow-lg">Fastest</div>}
                     <div className="flex flex-col xl:flex-row gap-12 items-stretch">
                        ...
                        <div className="flex-1 flex items-center gap-10">
                           <div className="text-center md:text-left">
                              ...
                              <p className="text-[10px] font-black text-primary uppercase mt-1">JFK</p>
                           </div>
                           <div className="flex-1 flex flex-col items-center px-4 relative">
                        ...
                        <div className="flex flex-row xl:flex-col justify-between items-center xl:items-end gap-10 min-w-[220px] border-t xl:border-t-0 xl:border-l border-navy-50 pt-8 xl:pt-0 xl:pl-10">
                           <div className="text-right">
                              <p className="text-[9px] font-black text-navy-400 uppercase tracking-widest mb-1">Price Difference</p>
                           ...
                           <button onClick={() => navigate('/manage-booking/XYZ123/review-change')} className="px-10 py-3.5 bg-navy-950 text-white text-[10px] font-black uppercase tracking-widest rounded-2xl hover:bg-primary shadow-xl shadow-navy-950/20 group-hover:scale-105 transition-all">Select Flight</button>
                        </div>
                     </div>
                  </div>
               ))}
         ...
         <div className="fixed bottom-10 left-1/2 -translate-x-1/2 w-full max-w-4xl px-8 z-40">
            <div className="bg-white/80 backdrop-blur-3xl border border-navy-100 p-8 rounded-[3.5rem] shadow-[0_40px_80px_-20px_rgba(0,0,0,0.15)] flex items-center justify-between gap-12 animate-in slide-in-from-bottom duration-1000">
               <div className="hidden md:flex items-center gap-6 border-r border-navy-50 pr-10">
                  ...
                  <div className="space-y-1">
                     <p className="text-[10px] font-black text-navy-950 uppercase tracking-tight leading-none">Security Check</p>
                     <p className="text-[8px] font-bold text-navy-400 uppercase tracking-widest leading-none">1 Passenger</p>
                  </div>
               </div>
               <div className="flex-1 text-right">
                  <p className="text-[9px] font-black text-navy-300 uppercase tracking-widest mb-1">Estimated Fees</p>
                  <p className="text-3xl font-black text-navy-950 tracking-tighter leading-none">--</p>
               </div>
               <button className="px-12 py-5 bg-navy-100 text-navy-300 font-black uppercase text-[10px] tracking-[0.2em] rounded-3xl cursor-not-allowed border border-navy-200">Confirm Change</button>
            </div>
         </div>
      </div>
   );

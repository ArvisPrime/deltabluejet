         ...
         <div className="w-full max-w-5xl grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
            ...
            <div className="space-y-10">
               <div className="space-y-6">
                  ...
                  <h1 className="text-6xl font-black text-navy-950 tracking-tighter uppercase leading-[0.9]">Manage <br />Your Trip</h1>
                  <p className="text-navy-500 font-medium italic text-xl leading-relaxed uppercase tracking-wider opacity-80">
                     Change your flights, select seats, and manage passengers in one place.
                  </p>
               </div>

               <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                  {[
                     { icon: 'edit_calendar', label: 'Change Flight', desc: 'Change date or route' },
                     { icon: 'airline_seat_recline_extra', label: 'Select Seat', desc: 'Choose your seat' },
                     { icon: 'luggage', label: 'Extra Baggage', desc: 'Add or remove bags' },
                     { icon: 'contact_support', label: 'Get Help', desc: 'Contact support' }
                  ].map((feat, i) => (
            ...
            <div className="bg-white rounded-[4rem] border border-navy-100 p-12 md:p-16 shadow-[0_50px_100px_-20px_rgba(0,0,0,0.15)] relative group overflow-hidden ring-1 ring-navy-50">
               ...
               <form className="space-y-12 relative z-10" onSubmit={handleRetrieve}>
                  ...
                  <div className="space-y-4">
                     <label className="text-[10px] font-black text-navy-400 uppercase tracking-[0.3em] block px-2">Passenger Last Name</label>
                     <div className="relative group/input">
               ...
               <div className="mt-12 pt-8 border-t border-navy-50 flex items-center gap-4 opacity-40">
                  ...
                  <p className="text-[8px] font-bold text-navy-400 uppercase tracking-[0.2em] leading-relaxed">
                     Connection secured by {BRAND.shortName} AES-256 Protocol. Passenger data is strictly confidential.
                  </p>
               </div>
            </div>

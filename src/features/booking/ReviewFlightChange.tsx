...
const ReviewFlightChange: React.FC = () => {
    ...
    <div className="p-8 max-w-7xl mx-auto space-y-10 animate-in fade-in duration-500 font-display pb-32">
      ...
      <div className="flex flex-col gap-4 max-w-4xl mx-auto w-full">
        <div className="flex justify-between items-end">
          ...
          <p className="text-navy-400 text-xs font-bold uppercase tracking-widest">Next: Payment</p>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-start">
        ...
        <div className="lg:col-span-8 space-y-8">
          <div className="space-y-2">
            ...
            <p className="text-navy-500 font-medium italic text-lg opacity-80">Review the changes. The original booking will be cancelled once confirmed.</p>
          </div>
          ...
          <div className="bg-amber-50 border border-amber-200 rounded-[2rem] p-6 flex gap-4 items-start shadow-sm">
            ...
            <div>
              ...
              <p className="text-amber-800 text-sm mt-1 font-medium leading-relaxed uppercase tracking-wide">
                Your new booking is non-refundable. Changes can be made up to 24 hours before departure for a standard re-triage fee.
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-col gap-8">
            ...
            <div className="relative p-10 rounded-[3rem] border border-navy-100 bg-white shadow-sm opacity-60 hover:opacity-100 transition-all group overflow-hidden">
              <div className="absolute top-6 right-8 bg-navy-50 text-navy-400 text-[10px] font-black px-4 py-1.5 rounded-full border border-navy-100 uppercase tracking-widest">Original Flight</div>
            ...
            <div className="relative p-10 rounded-[3.5rem] border-4 border-primary bg-white shadow-2xl space-y-8 group overflow-hidden">
              <div className="absolute top-6 right-8 bg-primary/5 text-primary text-[10px] font-black px-6 py-2 rounded-full border border-primary/10 uppercase tracking-widest">New Flight</div>
              ...
              <div className="pt-8 border-t border-navy-100 flex justify-between items-center">
                <div className="flex items-center gap-4">
                  ...
                  <div className="space-y-0.5">
                    <p className="text-sm font-black text-navy-950 uppercase tracking-tight">{BRAND.name}</p>
        ...
        <div className="lg:col-span-4 w-full">
          <div className="sticky top-8 space-y-6">
            <div className="bg-white rounded-[3.5rem] border border-navy-100 shadow-xl overflow-hidden flex flex-col">
              ...
              <div className="p-10 space-y-6">
                ...
                <div className="flex flex-col gap-4 pt-4">
                  <button
                    onClick={() => navigate('/manage-booking/XYZ123/change-success')}
            ...
            <div className="text-center">
              <button onClick={() => navigate(ROUTES.MANAGE_BOOKING)} className="text-[10px] font-black text-navy-300 uppercase tracking-widest hover:text-red-500 transition-colors underline decoration-2 underline-offset-4">Abort Modification Request</button>
            </div>
          </div>
        </div>
      </div>
